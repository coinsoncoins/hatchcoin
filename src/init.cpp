...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/hatchcoin-project/hatchcoin>";
    const std::string URL_WEBSITE = "<https://hatchcoin.org>";
