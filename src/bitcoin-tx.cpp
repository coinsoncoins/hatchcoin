...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s hatchcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  hatchcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded hatchcoin transaction") + "\n" +
              "  hatchcoin-tx [options] -create [commands]   " + _("Create hex-encoded hatchcoin transaction") + "\n" +
              "\n";
