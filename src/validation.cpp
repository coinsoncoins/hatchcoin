...
#if defined(NDEBUG)
# error "Hatchcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Hatchcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s HTC additional fees, %d delta bytes\n",
