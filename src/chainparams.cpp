...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.hatchcoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.hatchcointools.com", true);
        vSeeds.emplace_back("dnsseed.hatchcoinpool.org", true);
        ...
        chainTxData = ChainTxData{
            ...
            1525020164, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.hatchcointools.com", true);
        vSeeds.emplace_back("seed-b.hatchcoin.loshan.co.uk", true);
